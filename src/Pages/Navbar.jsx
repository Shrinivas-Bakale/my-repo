...
const Navbar = (props) => {
  return (
    <div>
      <nav
            className={` nav-main flex gap-4 p-8 justify-between bg-${props.mode} text-${props.mode === "gray-900" ? "white" : "black"} w-full`}
          >
            ...
            <div className="right flex gap-3">
              <input
                type="text"
                className="bg-gray-700 border-2 border-gray-400"
              />
